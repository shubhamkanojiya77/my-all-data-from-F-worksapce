...
public class NAVEENEXCEL2 {
	...
	public class XlsxReader {
		...
		public XlsxReader(String path) {// constructor
		...
		public int getRowCount(String sheetName) {
			int index = workbook.getSheetIndex(sheetName); // 0 , 1, 2 ,3
			if (index == -1)
				return 0;
			else {
				sheet = workbook.getSheetAt(index);
				int number = sheet.getLastRowNum() + 1; // imp
				return number;
			}
