...
public class HomePage extends LogInPage {
	...
	public HomePage(String username, String password)
	{
		...
		// HOME PAGE SELF KI KOI METHOD ABHI NAHI DE RAH HAI
	}
	...
	//variables dashborad
	 ...
	 private  WebElement cookiebutton;//a[@class="optanon-allow-all accept-cookies-button"]
	 // locators dashboard
	 
	
	public WebElement getCookie() {
		cookiebutton= browser.driver.findElement(By.xpath
				("//a[@class=\"optanon-allow-all accept-cookies-button\"]"));
		return cookiebutton;
	}
	...
	// logo functionality
	public void logofunctionality() throws InterruptedException {
		getLogoimg().click();
		Thread.sleep(5000);
		getCookie().click();
	}
