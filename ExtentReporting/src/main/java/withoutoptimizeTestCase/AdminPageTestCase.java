...
public class AdminPageTestCase {
	...
	@Test(description="Admin should be able to Add new the Admin or ESS user from employee list" )
	public void TC1() throws InterruptedException{
	ExtentTest test=Reporter.report.createTest("Admin should be able to Add Admin or ESS user from employee list");
	...
	{
	test.log(Status.PASS,"Admin is able to add a user");
	}
	else {	
	test.log(Status.FAIL,"Admin is able to add a user");	
	}	
	...
	@Test(description="Admin should be able to search the user",enabled=false)
	...
	/*
	@Test(description="Admin should be able to edit the user profile")
	...
	@Test(description="Admin should be able to delete the user profile")
